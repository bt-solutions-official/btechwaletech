...
const content: FreelanceContent = {
  ...
  guide: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `The Digital Personal Data Protection Act, 2023 applies to personal data held digitally, and the government notified the DPDP Rules on 14 November 2025, with most obligations phased in over eighteen months (the Press Information Bureau release gives the dates). For a clinic that means knowing why each field is collected, telling patients how their data is used, and being able to act on requests to correct records.`,
  ...
  faqs: [
    ...
    { question: "How do payments and contracts work with your team?", answer: "You receive an itemised written quote and nothing is billed before you approve it. Payments in India are by UPI or bank transfer, in stages tied to work you can see. Scope, milestones and ownership are written into the quote; any NDA or further terms are agreed in writing before work starts. See our terms and refund policy pages for the general conditions." },
