...
const content: FreelanceContent = {
  ...
  services: {
    ...
    cards: [
      ...
      { name: "Retained upkeep", note: `After five free months, monthly maintenance from ${P.care}: fixes, updates, backups and small changes on request.`, href: "/website-maintenance-freelancer/", size: "sm" },
  ...
  guide: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `Add the statutory items that apply to your business, such as provident fund and ESI contributions where your establishment is covered, and the gratuity liability that builds under the Payment of Gratuity Act, 1972. Add a capable laptop, paid tools and licences, cloud accounts for testing, internet, a seat, leave cover and any recruitment fee. Then add the owner's or a manager's time spent explaining requirements, checking progress and handling appraisals.`,
    ...
    {
      id: "three-year-view",
      heading: "How to compare the two over three years, not three months",
      paragraphs: [
  ...
  faqs: [
    ...
    { question: "What happens to support after an outsourced project ends?", answer: `Agree it before the build. BtechWaleTech includes five months of free support after go-live, covering fixes, small changes and updates. After that, you choose: continue maintenance from ${P.care}, move to another developer, or hand over to an in-house hire. Because the code and hosting are in your name, any of these works without permission from us.` },
