...
const content: FreelanceContent = {
  ...
  guide: [
    ...
    },
    {
      ...
      paragraphs: [
        `Recalls are where dental practices quietly lose the most revenue. Dental clinic software sets a recall rule when a treatment is completed, such as a check-up after six months or a review after an extraction, and sends a WhatsApp reminder when it falls due.`,
    ...
    },
    {
      ...
      paragraphs: [
        `Most practices go live with a first version of dental clinic software in 6 to 12 weeks. A single-branch clinic with standard workflows is closer to eight weeks; multi-branch practices with migration and a patient app take longer.`,
    ...
    },
    {
      ...
      paragraphs: [
        `Dental records, photos and radiographs are sensitive personal data, and the Digital Personal Data Protection Act, 2023 applies to how you collect and keep them. MeitY notified the DPDP Rules on 14 November 2025, with obligations coming into force in phases over about 18 months.`,
    ...
    },
    {
      ...
      paragraphs: [
        `Say a three-chair practice in Chandigarh has two full-time dentists, a visiting orthodontist on Tuesdays and Fridays, and an endodontist twice a week. It sends crowns and bridges to two labs, takes periapicals on an RVG sensor and refers OPGs to its own OPG machine in a small imaging room. Records are paper case sheets; staged payments sit in a diary; recalls happen when someone remembers.`,
  ...
  faqs: [
    ...
    { question: "Do we need a separate patient app?", answer: `Not necessarily. Most patients are happy with WhatsApp reminders, PDF estimates and bills, and secure image links. A branded Android and iOS app for bookings, plans, bills and images starts at ${P.app}, published in your own Google Play and App Store accounts. It makes more sense for larger practices and chains than for single-chair clinics.` },
    { question: "How do payments and contracts work with your team?", answer: "You get an itemised written quote with scope, phases and ownership terms, and nothing is billed until you approve it in writing. Payments in India are by UPI or bank transfer, staged against delivered work; clients abroad pay by Wise, bank wire or PayPal in USD. Any NDA or extra terms are agreed in writing, and our terms and refund policy pages cover the general conditions." },
